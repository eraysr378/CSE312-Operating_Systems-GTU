...
int InterruptManager::timerInterruptCount = 0;
...
uint32_t InterruptManager::DoHandleInterrupt(uint8_t interrupt, uint32_t esp)
{
    ...
    {
        // if(processManager->runningProcess->GetPid() == 1){
        //     processManager->collatzRunCount++;
        // }
        // if (processManager->collatzRunCount >= 5)
        // {
        //     processManager->runningProcess->SetPriority(110);
        //     processManager->collatzRunCount = 0;
        // }
        // else if (processManager->collatzRunCount <= -5)
        // {
        //     Process* collatz = processManager->GetProcessByPid(1);
        //     collatz->SetPriority(90);
        //     processManager->readyQueue.removePid(1);
